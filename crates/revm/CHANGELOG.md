...
## [9.0.0](https://github.com/wevm/revm/compare/revm-v8.0.0...revm-v9.0.0) - 2024-05-03

### Added
- *(Handler)* Add ClearHandle ([#1368](https://github.com/wevm/revm/pull/1368))
- Add uniswap V2 WETH-USDC swap example ([#1353](https://github.com/wevm/revm/pull/1353))
...
- *(`db`)* Introduce `alloydb` ([#1257](https://github.com/wevm/revm/pull/1257))
...
### Other
- *(ci)* bump action/deploy ([#1372](https://github.com/wevm/revm/pull/1372))
- shrink OpCodeInfo and add more methods ([#1307](https://github.com/wevm/revm/pull/1307))
- *(deps)* bump anyhow from 1.0.81 to 1.0.82 ([#1293](https://github.com/wevm/revm/pull/1293))
- fix some warnings ([#1305](https://github.com/wevm/revm/pull/1305))
- Update documentation ([#1275](https://github.com/wevm/revm/pull/1275))
- *(interpreter)* use `pop_top!` where possible ([#1267](https://github.com/wevm/revm/pull/1267))
- add and use EvmContext::take_error ([#1264](https://github.com/wevm/revm/pull/1264))
