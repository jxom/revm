...
## [6.1.0](https://github.com/wevm/revm/compare/revm-precompile-v6.0.0...revm-precompile-v6.1.0) - 2024-05-03
...
### Other
- *(deps)* bump aurora-engine-modexp from 1.0.0 to 1.1.0 ([#1339](https://github.com/wevm/revm/pull/1339))
- *(deps)* bump secp256k1 from 0.28.2 to 0.29.0 ([#1260](https://github.com/wevm/revm/pull/1260))
